	...
	<content>
		<div class="container">
			...
			<section class="col-md-10 col-md-offset-1">
				...
				<article class="row">
					<h3 class="col-md-offset-5 text-center">Conférence sur la créativité</h3>
					<div class="col-md-5">
				...
				<article class="row">
					<h3 class="col-md-offset-5 text-center">Marketing et étude de Marchés</h3>
					<div class="col-md-5">
						<img src="image/placeholder.png" alt="logo jonathan fechner" title="accueil" class="img-responsive">
					</div>
					<div class="col-md-7">
				...
				<article class="row">
					<h3 class="col-md-offset-5 text-center">Benchmark et conception web</h3>
					<div class="col-md-5">
						<img src="image/placeholder.png" alt="logo jonathan fechner" title="accueil" class="img-responsive">
					</div>
					<div class="col-md-7">
